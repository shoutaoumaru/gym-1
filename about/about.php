...
<head>
  ...
  <title>RivRoundについて | ジムテンプレート1</title>
  <?php get_header(); ?>
</head>
    ...
    <main id="main-contents" class="c-about">
      ...
      <section class="c-topview">
        <div class="c-topview__img">
          <img class="view-sp" src="<?php echo get_template_directory_uri(); ?>/images/home/shoose_1.jpg" alt="">
          <img class="view-pc" src="<?php echo get_template_directory_uri(); ?>/images/home/shuse@pc.jpg" alt="">
        </div>
      </section>
      <!-- /.c-topview -->
          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                  <p class="num">02</p>
                  <p class="item-tit">結果を生む質の高いメソッドとトレーナー</p>
                </div>
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  ...
                  <p class="c-txt-sm">
                    ボディメイク中はトレーニングによって失われた栄養素を補い、つくりあげた筋肉を落とさないことが肝心です。あなたのライフスタイルに合わせて専属トレーナーが正しい食事をアドバイス。</p>
                </div>
              </h4>
            </div>
          </li>
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                  <p class="num">04</p>
                  <p class="item-tit">健康を第一に確実に目標を達成させるコンセプト</p>
                </div>
                <div class="item-desc">
                  <p class="c-txt-sm">
        ...
        <div class="c-flow-content">
          ...
          <section id="flow05" class="c-flow-item">
            <div class="c-container">
              ...
              <div class="item-wrap">
                <h4 class="item-tit">
                  <p><span class="num">05</span>フィードバック</p>
                </h4>
                <div class="item-img view-sp">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/home/feedback.jpg" alt="">
                </div>
