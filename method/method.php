...
<head>
  ...
  <title>トレーニングメソッド | ジムテンプレート1</title>
  <?php get_header(); ?>
</head>
    ...
    <main id="main-contents" class="c-method">
      ...
      <section class="c-topview">
        <div class="c-topview__img">
          <img class="view-sp" src="<?php echo get_template_directory_uri(); ?>/images/home/method-top.jpg" alt="">
          <img class="view-pc" src="<?php echo get_template_directory_uri(); ?>/images/home/method-top.jpg" alt="">
        </div>
      </section>
      <!-- /.c-topview -->
      <section class="c-features">
        <div class="c-container">
          ...
          <div class="c-features__desc">
            <h3 class="c-txt-md">一人ひとりに合わせたトレーニングプログラムを、マンツーマン体制で丁寧にサポート。</h3>
            <p class="c-txt-sm">
      ...
      <section class="c-points">
        ...
        <ul>
          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">マシントレーニングはケーブルの軌道が決まっており初心者の方でも安全に行えるのが特徴です。狙った部位をピンポイントで追い込むことができます。
                  </p>
                </div>
              </h4>
            </div>
          ...
          <li class="c-points__item">
            <div class="c-points__img">
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/pushup.jpg" alt="">
            </div>
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  ...
                  <p class="c-txt-sm">脂肪燃焼効果や心肺機能の向上が期待できます。
                  </p>
                  <strong>ランニング(速度10.0km/1h、傾斜0)</strong>
                  <p class="c-txt-sm">ウォーキング同様、脂肪燃焼効果や心肺機能の向上が期待できます。
                  </p>
                </div>
              </h4>
            </div>
          ...
          <li class="c-points__item">
            <div class="c-points__img">
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/storech.jpg" alt="">
            </div>
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">筋トレは無酸素運動とよばれ負荷の高い運動のため、筋肉が硬くなりやすいです。
          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">トレーニング後はこれからの目標やプラグラムを立て直したり、食事バランスについてのアドバイスや相談をさせて頂きます。
                  </p>
                </div>
              </h4>
            </div>
