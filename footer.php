        ...
        <div class="p-footer__wrap">
          ...
          <div class="p-footer__nav">
            <ul>
              ...
              <li>
                <a class="animsition-link" href=" <?php echo esc_url( home_url('/trainers')); ?>"><span class="c-txt-sm">スタッフ紹介</span></a>
              </li>
              <li>
              ...
              <li>
                <a href=" <?php echo esc_url( home_url('/news')); ?>"><span class="animsition-link c-txt-sm">お知らせ</span></a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="mobile-menu">
      <nav class="mobile-menu__nav">
        <ul class="mobile-menu__list">
          ...
          <li class="mobile-menu__item"><a class="animsition-link" href=" <?php echo esc_url( home_url('/trainers')); ?>">スタッフ紹介</a></li>
